...
function ThemeChanger() {
  ...
  return (
    ...
    >
      <div tabIndex={0} className={`btn gap-2 normal-case ${btnClasses}`}>
        <svg
          width="20"
          height="20"
      ...
      <div
        className={`dropdown-content bg-base-200 text-base-content rounded-t-box rounded-b-box top-px h-96 w-52 overflow-y-auto shadow-2xl ${contentClasses}`}
      >
